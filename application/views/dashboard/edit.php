            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active"><a href="<?= base_url('dashboard/edit') . $dokumen['id'] ?>">Edit Dokumen</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?= form_open_multipart('dashboard/edit/' . $dokumen['id'])  ?>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control w-100" value="<?= $dokumen['nama'] ?>" name="nama" id="nama">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control w-100" value="<?= $dokumen['jenis'] ?>" name=" jenis" id="jenis">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control w-100" value="<?= $dokumen['pembuat'] ?>" name=" pembuat" id="pembuat">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-6 d-flex" style="justify-content: space-evenly">
                                        <?php foreach ($role as $r) :
                                            if ($r['id'] != 1) :
                                        ?>
                                                <input type="checkbox" class="form-control" name="akses<?= $r['id'] ?>" id="<?= $r['role'] ?>" <?= checkAccess($r['id'], $dokumen['id']) ?> value="<?= $r['id'] ?>">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control w-100" rows="2" name="link" id="link"><?= $dokumen['link'] ?></textarea>
