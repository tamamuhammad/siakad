        ...
        <div class="col-sm-10">
            ...
            <form action="" method="post">
                <div class="form-group">
                    <label for="currentPassword" class="col-sm-2 col-form-label">Password lama</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label for="repeatPassword" class="col-sm-2 col-form-label">Ulangi Password Baru</label>
                    <div class="col-sm-10">
